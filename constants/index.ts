...
export const SITE = {
  title: "Website laten maken & professioneel webdesign | Sarte Global",
  description:
    "Groei met webdesign: Sarte Global maakt professionele, conversiegerichte websites voor ondernemers en bedrijven in Nederland. Sterke SEO, snel en gebouwd om te groeien.",
  themeColor: "#0D0D0D",
  brandName: "SARTE GLOBAL",
  brandAccent: ".",
  url: "https://groeimetwebdesign.nl",
  name: "Sarte Global",
...
export const TRUST_LINE =
  "Groei met webdesign is een dienst van Sarte Global." as const;
...
export const NAV_ITEMS: readonly NavItem[] = [
  { kind: "link", label: "Groei met webdesign", href: "/" },
...
export const HERO = {
  ...
  title: [
    {
      words: [
        { text: "Groei met Webdesign dat jouw bedrijf" },
        { text: "laat groeien", italicAccent: true },
      ],
    },
  ],
  subtitle:
    "Sarte Global laat ondernemers in Nederland groeien met professioneel webdesign: snelle, conversiegerichte websites met sterke SEO — gebouwd om gevonden te worden en te verkopen.",
  ...
  scrollLabel: "Scroll",
  badgeText:
    "GROEI MET WEBDESIGN · SARTE GLOBAL · WEBSITE LATEN MAKEN · SARTE GLOBAL · ",
...
export const FOOTER_MISSION =
  "Groei met webdesign. Sarte Global bouwt professionele, conversiegerichte websites voor ondernemers en bedrijven in Nederland — gemaakt om gevonden te worden en te verkopen." as const;
...
export * from "./groei-met-webdesign";
