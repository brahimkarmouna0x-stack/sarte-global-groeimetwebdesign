...
export const ABOUT_COMPANY = {
  ...
  lead:
    "Sarte Global is het bureau achter groeimetwebdesign.nl. We bouwen professionele, moderne en responsive websites voor ondernemers en bedrijven in Nederland, met een focus op sterke SEO, snelle oplevering en meetbare groei.",
  paragraphs: [
  ...
  badge: "SARTE GLOBAL · GROEI MET WEBDESIGN · NEDERLAND",
