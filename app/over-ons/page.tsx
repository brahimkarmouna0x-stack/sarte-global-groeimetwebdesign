...
const PATH = "/over-ons";
const PAGE_TITLE = "Over Sarte Global — webdesignbureau in Nederland";
const PAGE_DESC =
  "Sarte Global is het webdesignbureau achter groeimetwebdesign.nl. We bouwen professionele, moderne websites voor ondernemers en bedrijven in Nederland — gericht op groei.";
